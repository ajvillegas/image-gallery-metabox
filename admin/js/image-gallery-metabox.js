...
(function( $ ) {
	...
	$( document ).on( 'click.igmbpAddMediaManager', '#image-gallery-meta-box a.gallery-add', function( e ) {
        ...
        media_frame.on( 'select', function() {
			...
			$( '#gallery-metabox-list' ).append( '<li><input type="hidden" name="_igmb_image_gallery_id[' + index + ']" value="' + attachment.id + '"><img class="image-preview" src="' + attachmentSource + '"><a class="edit-image" href="#" title="' + image_gallery_metabox.link_edit_title + '"></a><a class="remove-image" href="#" title="' + image_gallery_metabox.link_remove_title + '"></a></li>' );
			} );
