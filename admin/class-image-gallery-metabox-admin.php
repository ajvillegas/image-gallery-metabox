...
class Image_Gallery_Metabox_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/image-gallery-metabox-admin.min.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_register_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/image-gallery-metabox.min.js', array( 'jquery', 'jquery-ui-sortable' ), $this->version, false );
